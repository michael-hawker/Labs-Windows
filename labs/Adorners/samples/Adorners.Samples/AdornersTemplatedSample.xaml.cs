...
[ToolkitSample(id: nameof(AdornersTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class AdornersTemplatedSample : Page
{
    public AdornersTemplatedSample()
    {
