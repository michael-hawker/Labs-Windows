...
/// </summary>
public partial class Adorners_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Adorners_xBind"/> class.
    /// </summary>
    public Adorners_xBind()
    {
        this.DefaultStyleKey = typeof(Adorners_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Adorners_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Adorners_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
