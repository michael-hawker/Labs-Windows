...
public partial class Adorners_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Adorners_ClassicBinding"/> class.
    /// </summary>
    public Adorners_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(Adorners_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Adorners_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Adorners_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
