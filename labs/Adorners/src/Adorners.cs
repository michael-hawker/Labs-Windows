...
/// You can choose to start here or from the <see cref="Adorners_ClassicBinding"/> or <see cref="Adorners_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class Adorners : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(Adorners), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is Adorners panel)
        {
